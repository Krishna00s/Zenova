    ...
    <section ref={containerRef} id="contact" className="relative w-full bg-soft-white text-near-black py-16 sm:py-20 md:py-28 overflow-hidden">
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          {/* Right Glassmorphic Contact Form Column (Full Wide Spacious 7 Columns) */}
          <div className="lg:col-span-7 w-full contact-reveal flex flex-col">
            <div className="bg-soft-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 xl:p-12 border border-muted-lavender/80 shadow-xl space-y-5 h-full flex flex-col justify-between">
              {submitted ? (
